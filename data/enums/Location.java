...
public enum Location {
    ...
    VARROCK_EAST(      new RSTile(3286, 3365, 0), new RSTile(3222, 3217, 0), OreType.COPPER, OreType.TIN, OreType.IRON),
    ...
    SHILO_VILLAGE(     new RSTile(2824, 2999, 0), new RSTile(3222, 3217, 0), OreType.GEMS),
